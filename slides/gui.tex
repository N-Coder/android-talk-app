...
\frame{
	...
	\begin{center}
		...
		{\tiny http://www.pingmbh.de/download/medi01.png}
	\end{center}
}
\frame{
	\frametitle{GUI}
	\vspace{-3mm}
	\begin{center}
		\includegraphics[width=.8\textwidth]{pictures/bad_gui_1.jpg} \newline
		{\tiny http://www.superdownloads.com.br/imagens/screenshots/3/0/30730,O.jpg}
	\end{center}
}
\frame{
	\frametitle{GUI}
	...
	\begin{center}
		...
		{\tiny http://www.pouet.net/topic.php?which=9700}
	\end{center}
}
\frame{
	\frametitle{GUI}
	...
	\begin{center}
		...
		{\tiny http://www.mastermagazine.info/termino/wp-content/uploads/GUI.jpg}
	\end{center}
}
\frame{
