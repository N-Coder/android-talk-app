...
\frame[c]{
	...
	\textbf{Swing}
	\begin{figure}
	\includegraphics[width=0.8\textwidth]{pictures/activities/call-hierachy-swing.png}
	\end{figure}
	\vspace{0.2cm}\pause
	\textbf{Android}
	\begin{figure}
	\includegraphics[width=0.8\textwidth]{pictures/activities/call-hierachy-android.png}
	\end{figure}
}
...
\frame[c]{
	...
	\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{pictures/activities/activity_lifecycle.png}
	\end{figure}
	% \pause
	% \begin{columns}
	% \column{.5\textwidth}
...
\frame[t]{
	...
	\column{.3\textwidth}
	\begin{figure}
	\includegraphics[height=3cm]<5-6>{pictures/activities/implicit-intent-hierarchy-1.png}
	\includegraphics[height=3cm]<7>{pictures/activities/implicit-intent-hierarchy-2.png}
	\end{figure}
	\pause
	\column{.3\textwidth}
	\begin{figure}
	\includegraphics[height=3cm]<6->{pictures/activities/intent-choser.png}
	\end{figure}
	\column{.2\textwidth}
	\end{columns}
}